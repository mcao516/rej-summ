...
To run the code on your own data, first make sure that the data is formatted as one document/summary per line. Then, binarize your data following the steps here: https://github.com/mcao516/rej-summ/blob/main/examples/bart/README.summarization.md. You also need to run ``preprocessing.py`` to generate a mask file that contains the entity position information.
